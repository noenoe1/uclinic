...
<template>
    <div class="sticky top-0 z-40">
        <div class="w-full px-6 bg-background-500 dark:bg-backgrounddark-500  border-b flex items-center justify-between">
            ...
            <div class="flex w-full items-center justify-between my-5 ">
                ...
                <div class="flex items-center ">    
                    ...
                    <button class="hover:text-blue-500 hover:border-white focus:outline-none navbar-burger" @click="$emit('toogle-side-menu', 0)">
                            ...
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <template v-if="$page.jetstream.hasTeamFeatures">
                                        ...
                                        <jet-dropdown-link :href="route('psteams.create')" v-if="$page.jetstream.canCreateTeams">
                                            Create New Team
                                        </jet-dropdown-link>
