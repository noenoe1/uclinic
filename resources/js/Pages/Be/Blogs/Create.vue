        ...
        <template #header> 
            <div class=" rounded font-sans w-full">
                <ol class="list-reset flex text-gray-600 items-center">
                    <li><inertia-link href="/products/list" class=" text-blue-600 font-bold">{{$page.isDarkMode}} Blog List </inertia-link></li>
                    <li><span class="mx-2">/</span></li>
                    <li class="text-gray-400">Create New Blog</li>
                </ol>
            </div>
        </template>
                ...
                <template>
                    <jet-form-section @submitted="createBlog">
                        ...
                        <template #description>
                            Description for the New Creation Blog for your app. 
                        </template>
