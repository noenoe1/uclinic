        ...
        <template #header>
         ...
         <template>
            <div class="m-4 bg-background-100 dark:bg-backgrounddark-700 rounded-lg overflow-hidden">
                ...
                <div class="" >
                    <table class="w-full ">
                        ...
                        <tbody class="container text-center">
                            ...
                            <tr v-for="(department, index) in departments.data" :key="index" class=" shadow-sm"> 
                    ...
                    <nav class="w-full px-4 py-2 mt-2 items-end justify-end sm:px-6 inline-flex bg-background-300 dark:bg-backgrounddark-900 ">
                        <div v-for="link in departments.links" :key="link.path" class="row">
               ...
               <div v-for="dept in depts" :key="depts.id" class="row">
                    <p>{{dept.name}}</p>
                </div>
            </div>
        </template>
