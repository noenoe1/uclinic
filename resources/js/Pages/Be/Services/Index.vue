        ...
        <template #header>
         ...
         <template>
            <div class="m-4 bg-background-100 dark:bg-backgrounddark-700 rounded-lg overflow-hidden">
                        ...
                        <div class="flex justify-between w-full">    
                            <div class="flex items-center">
                                ...
                                <div class="relative text-gray-600 hidden sm:flex">
                                    <input type="search" name="serch" placeholder="Search services..." class="bg-background-500 dark:bg-backgrounddark-500 h-10 w-full xl:w-64 ps-5 pe-7 rounded-lg border border-background-300 dark:border-backgrounddark-700 text-sm focus:outline-none">
                ...
                <div class="" >
                    <table class="w-full ">
                        ...
                        <tbody class="container text-center">
                            ...
                            <tr v-for="(service, index) in services.data" :key="index" class=" shadow-sm"> 
                    ...
                    <nav class="w-full px-4 py-2 mt-2 items-end justify-end sm:px-6 inline-flex bg-background-300 dark:bg-backgrounddark-900 ">
                        <div v-for="link in services.links" :key="link.path" class="row">
                ...
                <div v-for="serv in servs" :key="serv.id" class="row">
                    <p>{{serv.name}}</p>
                </div>
            </div>
        </template>
