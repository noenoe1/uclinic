...
Route::middleware(['auth:sanctum', 'verified'])->group(function() {
    ...
    Route::get('/services/search/{keywords}', [ServiceController::class, 'search'])->name('services.search');
});
...
Route::middleware(['auth:sanctum', 'verified'])->group(function() {
    ...
    Route::get('/blogs/search/{keywords}', [BlogController::class, 'search'])->name('blogs.search');
...
Route::middleware(['auth:sanctum', 'verified'])->group(function() {
    ...
    Route::get('/departments/search/{keywords}', [DepartmentController::class, 'search'])->name('departments.search');
